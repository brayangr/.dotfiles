FactoryBot.define do
  factory :salary_payment do
    ...
    trait :with_apv_data do
      before(:create) do |salary_payment|
        byebug
        salary_payment.cotizacion_empleador_apvc = Faker::Number.between(from: 10, to: 20)
        salary_payment.cotizacion_trabajador_apvc = Faker::Number.between(from: 10, to: 20)
      end
    end
