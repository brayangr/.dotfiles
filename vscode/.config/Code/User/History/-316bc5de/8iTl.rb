FactoryBot.define do
  factory :salary_payment do
    ...
    trait :with_bonuses do
      advance_gratifications { Faker::Number.between(from: 1, to: 20) }
      anual_gratifications { Faker::Number.between(from: 1, to: 20) }
      bono_responsabilidad { Faker::Number.between(from: 1, to: 20) }
    end
