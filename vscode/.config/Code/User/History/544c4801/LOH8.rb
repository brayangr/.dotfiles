...
ActiveRecord::Schema[7.0].define(version: 2023_12_14_210821) do
  ...
  create_table "assign_payments", id: :serial, force: :cascade do |t|
    ...
    t.index "date_part('year'::text, paid_at)", name: "index_assign_payments_on_EXTRACT_year_FROM_paid_at"
  ...
  create_table "bonus_drafts", force: :cascade do |t|
    ...
    t.index ["salary_payment_draft_id"], name: "index_bonus_drafts_on_salary_payment_draft_id"
  end
  ...
  create_table "categories", id: :serial, force: :cascade do |t|
    ...
    t.index ["name", "sub_name"], name: "index_categories_on_name_and_sub_name"
  ...
  create_table "codi_settings", force: :cascade do |t|
  ...
  create_table "debts", id: :serial, force: :cascade do |t|
    ...
    t.integer "origin_id"
    t.string "origin_type"
    t.index "date_part('year'::text, priority_date)", name: "index_debts_on_EXTRACT_YEAR_FROM_priority_date"
  ...
  create_table "deductions", force: :cascade do |t|
    ...
    t.index ["debt_id", "deduction_group_id"], name: "deductions_constraint_debt_deduction_group", unique: true
  ...
  create_table "discounts_drafts", force: :cascade do |t|
    ...
    t.string "description"
    t.index ["salary_payment_draft_id"], name: "index_discounts_drafts_on_salary_payment_draft_id"
  end
  ...
  create_table "invoice_payments", id: :serial, force: :cascade do |t|
    ...
    t.integer "account_id"
    t.boolean "generated_pdf"
    t.string "document"
    t.string "receipt"
    t.index ["account_id"], name: "index_invoice_payments_on_account_id"
  end

  create_table "invoice_service_orders", force: :cascade do |t|
    t.bigint "invoice_id"
    t.bigint "service_order_id"
    t.index ["invoice_id"], name: "index_invoice_service_orders_on_invoice_id"
    t.index ["service_order_id"], name: "index_invoice_service_orders_on_service_order_id"
  end
  ...
  create_table "online_payment_trackings", force: :cascade do |t|
    t.bigint "property_id", null: false
    t.bigint "user_id", null: false
    t.bigint "purchase_order_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["property_id"], name: "index_online_payment_trackings_on_property_id"
    t.index ["purchase_order_id"], name: "index_online_payment_trackings_on_purchase_order_id"
    t.index ["user_id"], name: "index_online_payment_trackings_on_user_id"
  end

  create_table "online_payment_user_settings", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "settingable_type", null: false
    t.bigint "settingable_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["settingable_type", "settingable_id"], name: "index_online_payment_user_settings_on_settingable"
    t.index ["user_id"], name: "index_online_payment_user_settings_on_user_id"
  end
  ...
  create_table "period_expenses", id: :serial, force: :cascade do |t|
    ...
    t.index "date_part('year'::text, period)", name: "index_period_expenses_on_EXTRACT_year_FROM_period"
  ...
  create_table "property_account_statements", force: :cascade do |t|
    ...
    t.string "html_statement_file_name"
    t.string "html_statement_content_type"
    t.integer "html_statement_file_size"
    t.datetime "html_statement_updated_at", precision: nil
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "prospective_orders", force: :cascade do |t|
    t.bigint "prospective_id", null: false
    t.string "name"
    t.string "tin"
    t.string "email"
    ...
    t.string "user_name"
    t.string "user_mail"
    t.index ["prospective_id"], name: "index_prospective_orders_on_prospective_id"
  end
  ...
  create_table "prospectives", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_prospectives_on_user_id"
  end
  ...
  create_table "service_billings", id: :serial, force: :cascade do |t|
    ...
    t.index ["has_checks"], name: "index_service_billings_on_has_checks"
  ...
  create_table "service_orders", force: :cascade do |t|
    ...
    t.datetime "receipt_updated_at", precision: nil
    t.string "short_receipt_file_name"
    t.string "short_receipt_content_type"
    t.bigint "short_receipt_file_size"
    t.datetime "short_receipt_updated_at", precision: nil
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.index ["bill_number"], name: "index_service_orders_on_bill_number", unique: true
  end
  ...
  create_table "users", id: :serial, force: :cascade do |t|
    ...
    t.date "last_notification_date", default: "2020-09-30"
    ...
    t.string "avatar"
    t.datetime "prospective", precision: nil
  ...
  add_foreign_key "bonus_drafts", "salary_payment_drafts"
  ...
  add_foreign_key "discounts_drafts", "salary_payment_drafts"
  ...
  add_foreign_key "online_payment_trackings", "properties"
  add_foreign_key "online_payment_trackings", "purchase_orders"
  add_foreign_key "online_payment_trackings", "users"
  add_foreign_key "online_payment_user_settings", "users"
  ...
  add_foreign_key "prospective_orders", "prospectives"
  add_foreign_key "prospectives", "users"
