    ...
    context 'when called with a full time employee without draft for the payment period' do
      ...
      context 'when there are no previous salary payment' do
        ...
        it 'should set all other fields with default values' do
          ...
          expect(salary_payment.allocation_tool_wear
          expect(salary_payment.lost_cash_allocation
          expect(salary_payment.advance_gratifications
          expect(salary_payment.anual_gratifications
          expect(salary_payment.bono_responsabilidad
          expect(salary_payment.salary_additional_infos
          expect(salary_payment.union_fee
          expect(salary_payment.legal_holds
          expect(salary_payment.advance
          expect(salary_payment.ccaf
          expect(salary_payment.salary_additional_infos
          expect(salary_payment.apv
          expect(salary_payment.cotizacion_empleador_apvc
          expect(salary_payment.cotizacion_trabajador_apvc
          expect(salary_payment.spouse
          expect(salary_payment.spouse_voluntary_amount
          expect(salary_payment.spouse_periods_number
          expect(salary_payment.spouse_capitalizacion_voluntaria
          expect(salary_payment.employee_protection_law
          expect(salary_payment.protection_law_code
          expect(salary_payment.suspension_or_reduction_days
          expect(salary_payment.reduction_percentage
          expect(salary_payment.afc_informed_rent
          expect(salary_payment.adjust_by_rounding
        end
      end
    end
  end
