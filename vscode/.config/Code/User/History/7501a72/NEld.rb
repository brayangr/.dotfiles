  ...
  module SalaryPaymentDrafts
    class ResetResponse < BaseResponse
      ...
      def reset_license(license_id)
        @salary_payment_draft.update(updater_id: @user.id, license_drafts_attributes: {
          id: license_id, days: 0, start_date: nil, end_date: nil, ultimo_total_imponible_sin_licencia: 0
        })
      end
    end
  end
