  ...
  class SalaryPaymentDraftsController < ApplicationController
    ...
    def set_tabs
      @tabs = [
        ...
        {
          text: I18n.t('views.remunerations.salary_payment_drafts.taxable_bonus.title'),
          url: remuneration_salary_payment_drafts_path(tab: :taxable_bonus),
    ...
    def create_params
      params.require(:salary_payment_draft).permit(
        ...
        bonus_drafts_attributes: %i[type value post_tax]
      )
    end
