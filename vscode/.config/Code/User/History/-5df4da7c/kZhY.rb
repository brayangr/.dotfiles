  ...
  class SalaryPaymentDraftsController < ApplicationController
    ...
    def create_params
      params.require(:salary_payment_draft).permit(
        ...
        discounts_drafts_attributes: %i[days start_date end_date reason],
        another_discounts_drafts_attributes: %i[amount description],
        bonus_drafts_attributes: %i[bonus_type value post_tax]
      )
    end
    ...
    def update_params
      params.require(:salary_payment_draft).permit(
        ...
        discounts_drafts_attributes: %i[id days start_date end_date reason _destroy],
