  ...
  class SalaryPaymentDraftsController < ApplicationController
    ...
    def set_tabs
      @tabs = [
        ...
        {
          text: I18n.t('views.remunerations.salary_payment_drafts.bonus.title'),
          url: remuneration_salary_payment_drafts_path(tab: :bonus),
          active: @index == :bonus
        },
        {
        ...
        {
          text: I18n.t('views.remunerations.salary_payment_drafts.discounts_days.title'),
          url: remuneration_salary_payment_drafts_path(tab: :discounts_days),
          active: @index == :discounts_days
        },
        {
          text: I18n.t('views.remunerations.salary_payment_drafts.discounts.title'),
          url: remuneration_salary_payment_drafts_path(tab: :discounts),
    ...
    def create_params
      params.require(:salary_payment_draft).permit(
        ...
        discounts_drafts_attributes: %i[days start_date end_date reason amount description],
        bonus_drafts_attributes: %i[bonus_type name value post_tax]
      )
    end
    ...
    def update_params
      params.require(:salary_payment_draft).permit(
        ...
        discounts_drafts_attributes: %i[id days start_date end_date reason amount description _destroy],
<<<<<<< HEAD
        bonus_drafts_attributes: %i[id bonus_type value post_tax _destroy]
=======
        another_discounts_drafts_attributes: %i[id amount description _destroy],
        bonus_drafts_attributes: %i[id bonus_type name value post_tax _destroy]
>>>>>>> SAAS-3774/remunerations-qa
      )
    end

    def reset_params
      params.permit(:id, :tab, :columns)
    end
