module SalaryPayments
  class SalaryPaymentDirector
    def initialize(employee:, last_salary_payment: nil, salary_payment_draft: nil, period_expense:, payment_period_expense: nil, salary:)
      @employee = employee
    ...
    def build
      ...
      builder.build_worked_hours unless builder.is_a?(SalaryPayments::FullTimeBuilder)
