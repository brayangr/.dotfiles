...
class Employee < ApplicationRecord
  ...
  def full_name_last_name_first
    "#{self.father_last_name} #{self.mother_last_name} #{self.first_name}".downcase.titleize.strip
  end
  ...
  def strip_whitespace
    ...
    self.father_last_name = father_last_name.try(:strip)
    self.mother_last_name = mother_last_name.try(:strip)
  end
end
