...
ActiveRecord::Schema[7.0].define(version: 2023_12_14_211040) do
  ...
  create_table "assets", id: :serial, force: :cascade do |t|
    ...
    t.string "document"
    t.index ["documentable_type", "documentable_id"], name: "index_assets_on_documentable"
  end
  ...
  create_table "buy_orders", id: :serial, force: :cascade do |t|
    ...
    t.index ["payable_type", "payable_id"], name: "index_buyorders_on_payable"
  ...
  create_table "purchase_order_payments", id: :serial, force: :cascade do |t|
    ...
    t.index ["payable_type", "payable_id"], name: "index_purchase_order_payments_on_payable"
  ...
  create_table "purchase_orders", id: :serial, force: :cascade do |t|
    ...
    t.index ["billable_type", "billable_id"], name: "index_purchase_orders_on_billable"
