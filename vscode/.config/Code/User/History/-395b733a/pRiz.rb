module SalaryPayments
  ...
  class FullTimeBuilder < BaseBuilder
    ...
    def build_extra_hours
      @salary_payment.extra_hour = @last_salary_payment.extra_hour
      @salary_payment.extra_hour_2 = @last_salary_payment.extra_hour_2
      @salary_payment.extra_hour_3 = @last_salary_payment.extra_hour_3
    end
    ...
    def build_discounts
      ...
      @salary_payment.discount_days = @last_salary_payment.discount_days
    ...
    def build_licenses
      @salary_payment.dias_licencia = @last_salary_payment.dias_licencia
      @salary_payment.ultimo_total_imponible_sin_licencia = @last_salary_payment.ultimo_total_imponible_sin_licencia
    end
