    ...
    context 'with filters' do
      ...
      it 'should not delete discounts drafts that does not match the filters' do
        expect do
          ...
          .from(full_time_employee_salary_payment_draft.discounts_drafts.merge(DiscountsDraft.another_discount).count)
      end
      ...
      it 'should reset extra hours from salary payment drafts that match the filters' do
        expect do
          ...
          .from(another_part_time_employee_salary_payment_draft.discounts_drafts.merge(DiscountsDraft.another_discount).count).to(0)
      end
