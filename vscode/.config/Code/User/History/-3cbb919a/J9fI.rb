...
module Remuneration
  class SalaryPaymentsController < RemunerationApplicationController
    ...
    def create_massive
      ...
      payment_period_expense = current_community.period_expenses.where(
        period: "#{create_massive_params[:payment_period_expense_year]}-#{create_massive_params[:payment_period_expense_month]}-01"
      )
      period_expense = nil
