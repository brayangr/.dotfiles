  ...
  class BaseBuilder
    ...
    def to_h
...

      {
        ...
        bonos: additional_info_data[:bonus].map.with_index { |info, i| [i, info.attributes.compact] },
        discounts: additional_info_data[:discounts].map.with_index { |info, i| [i, info.attributes.compact] }
      }
    end
